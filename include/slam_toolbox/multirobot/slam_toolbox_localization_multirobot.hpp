...
#ifndef SLAM_TOOLBOX__SLAM_TOOLBOX_LOCALIZATION_MULTIROBOT_HPP_
#define SLAM_TOOLBOX__SLAM_TOOLBOX_LOCALIZATION_MULTIROBOT_HPP_
...
class LocalizationSlamToolboxMultirobot : public SlamToolboxMultirobot
{
public:
  explicit LocalizationSlamToolboxMultirobot(rclcpp::NodeOptions options);
  virtual ~LocalizationSlamToolboxMultirobot() {}
...
#endif  // SLAM_TOOLBOX__SLAM_TOOLBOX_LOCALIZATION_MULTIROBOT_HPP_
