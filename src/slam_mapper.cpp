...
/*****************************************************************************/
{
  ...
  if(not node->has_parameter("use_scan_matching") &&
  ...
  if(not node->has_parameter("use_scan_barycenter") &&
  ...
  if(not node->has_parameter("minimum_travel_distance") &&
  ...
  if(not node->has_parameter("minimum_travel_heading") &&
  ...
  if(not node->has_parameter("scan_buffer_size") &&
  ...
  if(not node->has_parameter("scan_buffer_maximum_scan_distance") &&
  ...
  if(not node->has_parameter("link_match_minimum_response_fine") &&
  ...
  if(not node->has_parameter("link_scan_maximum_distance") &&
  ...
  if(not node->has_parameter("loop_search_maximum_distance") &&
  ...
  if(not node->has_parameter("do_loop_closing") &&
  ...
  if(not node->has_parameter("loop_match_minimum_chain_size") &&
  ...
  if(not node->has_parameter("loop_match_maximum_variance_coarse") &&
  ...
  if(not node->has_parameter("loop_match_minimum_response_coarse") &&
  ...
  if(not node->has_parameter("loop_match_minimum_response_fine") &&
  ...
  if(not node->has_parameter("correlation_search_space_dimension") &&
  ...
  if(not node->has_parameter("correlation_search_space_resolution") &&
  ...
  if(not node->has_parameter("correlation_search_space_smear_deviation") &&
  ...
  if(not node->has_parameter("loop_search_space_dimension") &&
  ...
  if(not node->has_parameter("loop_search_space_resolution") &&
  ...
  if(not node->has_parameter("loop_search_space_smear_deviation") &&
  ...
  if(not node->has_parameter("distance_variance_penalty") &&
  ...
  if(not node->has_parameter("angle_variance_penalty") &&
  ...
  if(not node->has_parameter("fine_search_angle_offset") &&
  ...
  if(not node->has_parameter("coarse_search_angle_offset") &&
  ...
  if(not node->has_parameter("coarse_angle_resolution") &&
  ...
  if(not node->has_parameter("minimum_angle_penalty") &&
  ...
  if(not node->has_parameter("minimum_distance_penalty") &&
  ...
  if(not node->has_parameter("use_response_expansion") &&
